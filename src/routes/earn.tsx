...
const secondary = "text-[#bdbdbd] light:text-neutral-600";
      ...
      >
        <div className="font-manrope mx-auto w-full max-w-[1100px] space-y-6">
          <header className="space-y-1.5">
            <h1 className="text-[28px] font-extrabold leading-normal text-white light:text-neutral-900">Earn</h1>
          ...
          <div className="flex flex-col items-stretch gap-6 lg:flex-row">
            <section className="flex flex-1 flex-col gap-4 rounded-[20px] border border-border bg-card p-6">
              <div className="space-y-2">
                <div className="flex flex-wrap items-center gap-2">
                  <h2 className="text-lg font-extrabold text-white light:text-neutral-900">Get paid for invites</h2>
              ...
              <div className="space-y-2">
                <div className="flex items-stretch gap-2">
                  <div className="flex h-11 min-w-0 flex-1 items-center rounded-xl border border-border bg-background px-3 light:bg-[#F8F8F8]">
                    <p className="truncate text-[13px] font-bold text-white light:text-neutral-900">{link}</p>
                  </div>
                  <Button
                    variant="outline"
                    onClick={copyLink}
              ...
              <div className="flex flex-1 flex-col items-center justify-center rounded-[18px] border border-border bg-background p-5 light:bg-[#F8F8F8]">
                <div className="flex flex-col items-center gap-8">
                  ...
                  <div className="flex items-center gap-3">
                    <button
                      ...
                      className="flex h-11 items-center gap-2 rounded-xl bg-white px-3.5 text-[13px] font-extrabold text-[#0b0b0b] transition-opacity hover:opacity-90 light:bg-neutral-900 light:text-white"
                    >
                      <img src="/earn/smartphone.svg" alt="" className="size-[18px] light:invert" />
                      Add to Apple Wallet
                    </button>
                    <a
                      href="/earn/qr.png"
                      download="isla-invite-qr.png"
                      className="flex h-11 items-center gap-2 rounded-xl border border-border bg-[#0b0b0b] px-3.5 text-[13px] font-extrabold text-white transition-opacity hover:opacity-90 light:bg-white light:text-neutral-900"
                    >
                      <img src="/earn/download.svg" alt="" className="size-[18px] light:invert" />
                      Download
                    </a>
                  </div>
                </div>
            ...
            <div className="flex w-full shrink-0 flex-col gap-4 lg:w-[286px]">
              <section className="flex flex-col gap-3.5 rounded-[20px] border border-border bg-card p-5">
                <div className="flex items-center gap-3">
                  <div className="flex size-11 shrink-0 items-center justify-center rounded-full bg-white light:bg-neutral-900">
                    <span className="text-base font-extrabold text-[#0b0b0b] light:text-white">{CURRENT_USER.initials}</span>
                  </div>
                  <div className="space-y-0.5">
                    <p className="text-sm font-extrabold leading-[21px] text-white light:text-neutral-900">
                      {CURRENT_USER.name}
                    </p>
                ...
                <div className="space-y-2.5">
                  <StatRow label="Platform total" value={usd(PLATFORM_TOTAL)} valueClass="text-white light:text-neutral-900" />
                  <StatRow label="Your total earnings" value={usd(earnings)} />
                  <StatRow
                    label="Active referrals"
                    value={String(referrals)}
                    valueClass={referrals > 0 ? "text-green-400 light:text-green-700" : undefined}
                  />
                </div>
              </section>
              ...
              <section className="flex flex-col gap-3.5 rounded-[20px] border border-border bg-card p-5">
                <div className="flex items-center justify-between">
                  <p className="text-base font-extrabold text-white light:text-neutral-900">WITHDRAWAL</p>
                  <p className={cn("text-xs", secondary)}>Manual</p>
                </div>
                <div className="space-y-1 rounded-2xl border border-border bg-background p-4 light:bg-[#F8F8F8]">
                  <p className={cn("text-[11px] uppercase leading-[16.5px] tracking-[0.55px]", secondary)}>
                    Available to withdraw
                  </p>
                  <p className="text-[28px] font-extrabold leading-[35px] text-white light:text-neutral-900">
                    {usd(earnings)}
                  </p>
                </div>
                <Button
                ...
                <div className="space-y-1 rounded-xl border border-border bg-background p-3 light:bg-[#F8F8F8]">
                  <p className="text-xs font-extrabold leading-[18px] text-white light:text-neutral-900">Payments</p>
          ...
          <section className="flex flex-col gap-5 rounded-[20px] border border-border bg-card p-6">
            <div className="flex flex-wrap items-center justify-between gap-3">
              <h2 className="text-lg font-extrabold text-white light:text-neutral-900">Activity</h2>
              <Tabs
                value={filter}
                onValueChange={(v) => {
            ...
            {filled ? (
                ...
                {hidden > 0 && (
                  <div className="pt-3">
                    <button
                      ...
                      className="flex h-9 w-full items-center justify-center text-[13px] font-bold text-[#f8f8f8] hover:opacity-80 light:text-neutral-900"
                    >
              ...
              <div className="flex flex-col items-center gap-1.5 pb-1 pt-3 text-center">
                <p className="text-[13px] font-bold text-[#f8f8f8] light:text-neutral-900">No earnings yet</p>
...
function QrCard() {
  ...
  return (
    ...
    >
      ...
      >
        <div className="relative size-[202px] overflow-hidden rounded-[18px] light:hidden">
          <img
            src="/earn/qr.png"
            alt="Invite QR code"
        ...
        <div className="hidden size-[202px] rounded-[18px] border border-neutral-200 bg-white p-[22px] shadow-[0_10px_30px_rgba(15,23,42,0.12)] light:block">
          <div className="relative size-[158px] overflow-hidden rounded-xl bg-white">
            <img
              src="/earn/qr.png"
              alt="Invite QR code"
              className="absolute left-[-53px] top-[-52px] h-[268px] w-[267px] max-w-none"
            />
          </div>
        </div>
      </div>
...
function StatRow({
  label,
  value,
  valueClass = "text-[#f8f8f8] light:text-neutral-900",
}: {
  label: string;
  value: string;
  valueClass?: string;
      ...
      <div className="flex items-center gap-3.5 px-1 py-4">
        <div
          className={cn(
            ...
            isCommission ? "bg-[#0d1a2e] light:bg-blue-100" : "bg-[#1e1600] light:bg-amber-100",
          )}
        >
          <img
            src={isCommission ? "/earn/arrow-up.svg" : "/earn/arrow-down.svg"}
            alt=""
            className="size-[18px] light:brightness-75"
          />
        </div>
        <div className="min-w-0 flex-1">
          <p className="text-sm font-bold leading-[17.5px] text-white light:text-neutral-900">{entry.title}</p>
          <p className={cn("pt-0.5 text-[13px] leading-[19.5px]", secondary)}>
            {entry.subtitle} · {entry.date}
          </p>
        </div>
        {isCommission ? (
          <span className="rounded-full bg-[#0a2a1a] px-[7px] py-1 text-xs font-bold leading-[18px] text-green-400 light:bg-green-100 light:text-green-700">
            Commission
          </span>
        ) : (
          <span className="rounded-full border border-[#3a3a3a] bg-[#1e1e1e] px-2.5 py-1 text-xs font-bold leading-[18px] text-[#9c9c9c] light:border-neutral-300 light:bg-neutral-100 light:text-neutral-600">
            Paid
          </span>
        )}
        <p
          className={cn(
            ...
            isCommission ? "text-green-400 light:text-green-700" : "text-white light:text-neutral-900",
          )}
        >
          {isCommission ? "+" : "-"}
          {usd(entry.amount)}
...
function StripeDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="font-manrope max-w-[448px] gap-0 rounded-3xl border-[#333] bg-[#1e1e1e] px-[46px] pb-8 pt-[66px] light:border-neutral-200 light:bg-white sm:rounded-3xl">
        ...
        <DialogTitle className="mt-4 text-center text-base font-bold text-white light:text-neutral-900">
          Set up payouts with Stripe
        </DialogTitle>
        <DialogDescription className="mt-3 text-center text-[13px] leading-relaxed text-[#bdbdbd] light:text-neutral-600">
        ...
        <button
          ...
          className="mt-4 py-2 text-sm font-bold text-white hover:opacity-80 light:text-neutral-900"
        >
          Cancel
        </button>
      </DialogContent>
...
function CustomizeDialog({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="font-manrope max-w-[448px] gap-0 rounded-3xl border-[#333] bg-[#1e1e1e] p-[46px] light:border-neutral-200 light:bg-white sm:rounded-3xl">
        <DialogTitle className="text-lg font-bold text-white light:text-neutral-900">Customize your code</DialogTitle>
        <DialogDescription className="mt-1 text-[13px] text-[#bdbdbd] light:text-neutral-600">
          Pick a memorable code for your invite link.
        </DialogDescription>
        <label className="mt-7 flex h-11 items-center gap-1 rounded-xl border border-border bg-background px-4 text-sm light:bg-[#F8F8F8]">
          <span className="shrink-0 text-[#9c9c9c] light:text-neutral-500">https://isla.app/join/</span>
          <input
            value={draft}
            ...
            className="min-w-0 flex-1 bg-transparent font-bold text-white outline-none light:text-neutral-900"
          />
        </label>
        <div className="mt-6 flex items-center justify-end gap-3">
          <Button
            variant="outline"
            onClick={() => onOpenChange(false)}
            className="h-10 w-[98px] border-border bg-[#1a1a1a] text-sm font-bold text-white light:bg-white light:text-neutral-900"
          >
            Cancel
          </Button>
          <Button
